...
import "@/components/tiptap-components/tiptap-node/blockquote-node/blockquote-node.scss"
import "@/components/tiptap-components/tiptap-node/code-block-node/code-block-node.scss"
import "@/components/tiptap-components/tiptap-node/horizontal-rule-node/horizontal-rule-node.scss"
...
import "@/components/tiptap-components/tiptap-node/heading-node/heading-node.scss"
